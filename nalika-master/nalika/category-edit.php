                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="review-tab-pro-inner">
                        <ul id="myTab3" class="tab-review-design">
                            <li style="margin-left: calc(50% - 100px);"class="active"><a href="#description"><i class="icon nalika-edit" aria-hidden="true"></i> ajouter Collection </a></li>
                        </ul>
                        <div id="myTabContent" class="tab-content custom-product-edit">
                            <form method="POST" action="ajoutcollection.php" id="send" enctype="multipart/form-data">
                                <div class="product-tab-list tab-pane fade active in" id="description">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="margin-left: 400px;">
                                            <div class="review-content-section">
                                                <div class="input-group mg-b-pro-edt">
                                                    <span class="input-group-addon"><i class="icon nalika-user" aria-hidden="true"></i></span>
                                                    <input type="text" class="form-control" placeholder="Nom de la categorie"required pattern="[a-zA-Z0-9+' ]{1,}" id="nomcollection" name="nomcollection" title="Nom">
                                                </div>
                                                <div class="input-group mg-b-pro-edt">
                                                    <span class="input-group-addon"><i class="fas fa-table"></i></span>
                                                    <input type="text" class="form-control" name="an" id="an" placeholder="Année">
                                                </div>
                                                <div class="input-group mg-b-pro-edt">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="text-center custom-pro-edt-ds">
                                                <input type="submit" type="button" name="" class="btn btn-ctl-bt waves-effect waves-light m-r-10" value="Ajouter">
                    ...
                    <div class="review-tab-pro-inner">
                        <ul id="myTab3" class="tab-review-design">
                            <li style="margin-left: calc(50% - 100px);"class="active"><a href="#description"><i class="icon nalika-edit" aria-hidden="true"></i> modifier Collection </a></li>
                        </ul>
                        <div id="myTabContent" class="tab-content custom-product-edit">
                            <form method="POST" action="modifiercollection.php" id="send" enctype="multipart/form-data">
                                <div class="product-tab-list tab-pane fade active in" id="description">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="margin-left: 400px;">
                                            <div class="review-content-section">
                                              <?php
                                                  ...
                                                  if(isset($_POST['id']))
                                                  {
                                                   $liste = CollectionR::recupererCollection($_POST['id']);
                                                  }
                                                  else
                                                  {
                                                    $liste['id']=0;
                                              ...
                                              ?>
                                                <div class="input-group mg-b-pro-edt">
                                                    <span class="input-group-addon"><i class="icon nalika-user" aria-hidden="true"></i></span>
                                                   <?php echo'<input type="text" class="form-control" placeholder="'.$liste['nomc'].'"required pattern="[a-zA-Z0-9+'.' ]'.'{1,}" id="nomcollection" name="nomc" title="Nom">';
                                                   ?>
                                                </div>
                                                <div class="input-group mg-b-pro-edt">
                                                    <span class="input-group-addon"><i class="fas fa-table"></i></span>
                                                    <?php echo'<input type="text" class="form-control" name="an" id="an" placeholder="'.$liste['an'].'">';
                                                    ?>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="text-center custom-pro-edt-ds">
                                                <?php echo'<button type="submit" name="id" class="btn btn-ctl-bt waves-effect waves-light m-r-10" value="'.$liste['id'].'">Enregistrer</button>';?>
                                                <button type="button" class="btn btn-ctl-bt waves-effect waves-light">Discard
                                                </button>
                                            </div>
                                        </div>
