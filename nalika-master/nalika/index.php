...
<body>
  ...
  include "../../config/config.php";
    ...
    $req1 = $db->query("SELECT COUNT(*) as nb1 FROM file_img WHERE id=id  ");
    $nb1 = $req1->fetch();

    $req2 = $db->query("SELECT COUNT(*) as nb2 FROM promo WHERE Pref=Pref ");
    $nb2 = $req2->fetch();



    $dataPoints = array(
      array("label" => 'nombre des publicity', "y" => intval($nb1['nb1'])),
      array("label" => 'nombre des promotions', "y" => intval($nb2['nb2'])),
    ...
    <script>
      window.onload = function() {
        ...
        var chart = new CanvasJS.Chart("chartContainer", {
          ...
          title: {
            text: "Statistique des evenements et des prommotions "
          },
          data: [{
