...
<body>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Dashboard v.1" href="stat.php"><span class="mini-sub-pro">Statistique</span></a></li>
 ...
 <li><a title="Product Cart" href="list_promotion.php"><span class="mini-sub-pro">List Promotion</span></a></li>
                                 <li><a title="Product Detail" href="product-Promotion.php"><span class="mini-sub-pro">Product Promotion</span></a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li style="margin-left: calc(50% - 100px);" class="active"><a href="#description"><i class="icon nalika-edit" aria-hidden="true"></i>ajouter article</a></li>
                                </ul>
                                <div id="myTabContent" class="tab-content custom-product-edit">
                                    <form method="POST" action="ajouterpromo.php" enctype="multipart/form-data">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Réference" required pattern="[A-Za-z0-9' ]{1,}" name="Pref" title="Nom"  oninvalid="setCustomValidity('please use alphanumeric[a-Z][0-9]')">
                                                    </div>
                                                   
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-usd" aria-hidden="true"></i></span>
                                                        <input type="text" class="form-control" name="discount" placeholder="Discount" pattern="[0-9.' ]{1,}" oninvalid="setCustomValidity('please insert only numbers [0-9]')">
                                                    </div>
                                                  
                                                    <!--<div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-new-file" aria-hidden="true"></i></span>
                                                        <input type="text" class="form-control" name="margedage" placeholder="Marge d'age" oninvalid="setCustomValidity('please insert only numbers [0-9]')" >
                                                    </div>-->
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-favorites" aria-hidden="true"></i></span>
                                                        <input type="text" class="form-control" name="saisons"placeholder="Saisons" pattern="[A-Za-z0-9' ]{1,}" oninvalid="setCustomValidity('please use alphanumeric[a-Z][0-9]')">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div style="margin-top: 78px;" class="review-content-section">
                                                   
                                                    <?php
                                                         include "../../core/Produit.php";
                                                        $sql= 'SELECT id,nomc FROM categorie ORDER BY an';
                     ...
                     <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li style="margin-left: calc(50% - 100px);" class="active"><a href="#description"><i class="icon nalika-edit" aria-hidden="true"></i>Modifier article</a></li>
                                </ul>
                                <div id="myTabContent" class="tab-content custom-product-edit">
                                    <form method="POST" action="updatepromo1.php" enctype="multipart/form-data">
                                    <div class="product-tab-list tab-pane fade active in" id="description">
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                  ...
                                                  if(isset($_POST['id']))
                                                  {
                                                   $liste = promoC::recuperer($_POST['id']);
                                                  }
                                                  else
                                                  {
                                                    $liste['Pref']="Réference";
                                                  
                                                    $liste['discount']="Discount";
                                                    $liste['saisons']="Saisons";
                                                    
                                                    $liste['id']="pas d'article a éditer";
                                                  }
                                                    ?>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-user" aria-hidden="true"></i></span>
                                                       <?php echo '<input type="text" class="form-control" placeholder="'.$liste['Pref'].'" required pattern="[A-Za-z0-9'.']'.'{1,}'.'" name="Pref" title="Nom">';?>
                                                    </div>
                                                    
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-usd" aria-hidden="true"></i></span>
                                                       <?php echo '<input type="text" class="form-control" name="discount" placeholder="'.$liste['discount'].'" pattern="[0-9. ]{1,}">' ;?>
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-favorites" aria-hidden="true"></i></span>
                                                        <?php echo'<input type="text" class="form-control" name="saisons" placeholder="'.$liste['saisons'].'">';?>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div style="margin-top: 115px;" class="review-content-section">
                                                    <select name="select" class="form-control pro-edt-select form-control-primary">
                                                             <?php   
                                                                $sql ='SELECT id,nomc FROM categorie';
                                                                $db = config::getConnexion();
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center custom-pro-edt-ds">
                                                    <?php echo'<button type="submit" name="id" type="button" value="'.$liste['Pref'].'" class="btn btn-ctl-bt waves-effect waves-light m-r-10"value="Save">Enregistrer</button>'?>
                                                    <button type="button" class="btn btn-ctl-bt waves-effect waves-light">Discard
                                                        </button>
                                                </div>
                                            </div>
