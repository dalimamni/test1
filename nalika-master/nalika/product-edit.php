                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Dashboard v.1" href="index.php"><span class="mini-sub-pro">Statistique</span></a></li>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Réference" required pattern="[A-Za-z0-9' ]{1,}" name="ref" title="Nom"  oninvalid="setCustomValidity('please use alphanumeric[a-Z][0-9]')">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-edit" aria-hidden="true"></i></span>
                                                        <input type="text" name="nom" class="form-control" placeholder="Nom du produit" required pattern="[A-Za-z0-9]{1,}"oninvalid="setCustomValidity('please use alphanumeric [a-Z][0-9]')">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" class="form-control" name="description"placeholder="Description" pattern="[A-Za-z0-9' ]{1,}" oninvalid="setCustomValidity('please use alphanumeric[a-Z][0-9]')">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div id="myTabContent" class="tab-content custom-product-edit">
                                    ...
                                    <div class="product-tab-list tab-pane fade active in" id="description">
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                  ...
                                                  if(isset($_POST['id']))
                                                  {
                                                   $liste = ArticleR::recupererArticle($_POST['id']);
                                                  }
                                                  else
                                                  {
                                                    $liste['ref']="Réference";
                                                    $liste['nom']="Nom de l'article";
                                                    $liste['prix']="prix";
                                                    $liste['description']="Description";
                                                    $liste['nomc']="Nom de la collection";
                                                    $liste['id']="pas d'article a éditer";
                                                  }
                                                    ?>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-user" aria-hidden="true"></i></span>
                                                       <?php echo '<input type="text" class="form-control" placeholder="'.$liste['ref'].'" required pattern="[A-Za-z0-9'.']'.'{1,}'.'" name="ref" title="Nom">';?>
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-edit" aria-hidden="true"></i></span>
                                                       <?php echo'<input type="text" name="nom" class="form-control" placeholder="'.$liste['nom'].'" required pattern="[A-Za-z0-9]{1,}">';?>
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-usd" aria-hidden="true"></i></span>
                                                       <?php echo '<input type="text" class="form-control" name="prix" placeholder="'.$liste['prix'].'" pattern="[0-9. ]{1,}">' ;?>
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-favorites" aria-hidden="true"></i></span>
                                                        <?php echo'<input type="text" class="form-control" name="description"placeholder="'.$liste['description'].'">';?>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center custom-pro-edt-ds">
                                                    <?php echo'<button type="submit" name="id" type="button" value="'.$liste['ref'].'" class="btn btn-ctl-bt waves-effect waves-light m-r-10"value="Save">Enregistrer</button>'?>
                                                    <button type="button" class="btn btn-ctl-bt waves-effect waves-light">Discard
                                                        </button>
                                                </div>
                                            </div>
