	...
	<div class="banner-bottom1">
		<div class="agileinfo_banner_bottom1_grids">
			<div class="col-md-7 agileinfo_banner_bottom1_grid_left">
				<h3>Grand Opening Event With flat<span><?php
$sql='SELECT Pref,discount FROM promo where saisons ="summer"';
		$db = config::getConnexion();
				foreach  ($db->query($sql) as $row)
				{
					?><?php echo $row["discount"] ; ?> <?php
  }

    
?>% <i>Discount</i></span></h3>
  ...
  {
  	?>
						<img src="<?php echo '../../../nalika-master/nalika/upload/'.$row['image']; ?>" class="img-responsive" alt=" "  /><?php
  }
...
?>
							...
							<?php
$sql='SELECT Pref,discount FROM promo where saisons ="winter"';
		$db = config::getConnexion();
				foreach  ($db->query($sql) as $row)
				{
					?> 
<div class="w3agile_special_deals_grid_left_grid_pos1">
							<h5><?php echo $row["discount"] ; ?>%<span>Off/-</span></h5><?php
  }
...
?>
				...
				<div class="w3agile_special_deals_grid_left_grid">
				<?php
$sql='SELECT id,image FROM file_img where id ="8"';
		$db = config::getConnexion();
				foreach  ($db->query($sql) as $row)
				{
					?><img src="<?php echo '../../../nalika-master/nalika/upload/'.$row['image']; ?>" class="img-responsive" alt=" "  /> 
